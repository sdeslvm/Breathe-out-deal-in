...
protocol WebLoadable: AnyObject {
    var state: BreatheWebStatus { get set }
...
final class BreatheWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
    // MARK: - Свойства

    @Published var state: BreatheWebStatus = .standby
...
extension BreatheWebLoader: WKNavigationDelegate {
