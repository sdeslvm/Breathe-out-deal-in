...
# Параметры
BUNDLE_ID="com.breatheoutdeal.zorn"
APPLE_ID="6751941899"
REMOTE_URL="git@github.com:sdeslvm/Breathe-out-deal-in.git"
PROJECT_NAME="Breathe out deal in"
SCHEME_NAME="Breathe out deal in"
