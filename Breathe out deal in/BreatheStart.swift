...
struct BreatheWebViewBox: UIViewRepresentable {
    // MARK: - Свойства

    @ObservedObject var loader: BreatheWebLoader

    // MARK: - Координатор

    func makeCoordinator() -> BreatheWebCoordinator {
        BreatheWebCoordinator { [weak loader] status in
