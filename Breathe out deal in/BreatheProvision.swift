...
class BreatheWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    private let callback: (BreatheWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (BreatheWebStatus) -> Void) {
