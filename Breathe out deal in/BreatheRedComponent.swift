...
struct BreatheGameInitialView: View {
    private var gameResourceURL: URL { URL(string: "https://dealnbreathee.com/start")! }

    var body: some View {
        ZStack {
            Color(hex: "#000")
                .ignoresSafeArea()
            BreatheEntryScreen(loader: .init(resourceURL: gameResourceURL))
        }
    }
}

#Preview {
    BreatheGameInitialView()
}
