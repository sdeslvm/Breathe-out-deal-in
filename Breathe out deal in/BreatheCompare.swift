...
enum BreatheWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: BreatheWebStatus) -> Bool {
        switch (self, other) {
...
extension BreatheWebStatus {
    static func == (lhs: BreatheWebStatus, rhs: BreatheWebStatus) -> Bool {
